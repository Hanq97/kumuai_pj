...
ゼロマネは、育成就労制度への移行を見据えて、システムの自動アップデート機能を実装しています。法改正に伴う書類フォーマットの変更も、システムが自動で対応するため、お客様の作業負担を最小限に抑えます。
    `,
    category: "法改正情報",
    date: "2025-02-20",
    author: "田中 健太",
  ...
  },
  {
    ...
    title: "ゼロマネ新機能：在留カード期限アラートの設定方法",
...
support@zeromane.jp
  ...
  },
  {
    ...
    excerpt: "長年Excel管理を続けてきた監理団体様がゼロマネに移行された事例をご紹介。移行のきっかけから効果まで、詳しくお聞きしました。",
    content: `
## インタビュー概要
...
複数のシステムを比較検討した結果、ゼロマネを選んだ理由は3つ。
